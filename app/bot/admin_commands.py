...
_ADMIN_HELP = (
    ...
    "*📅 Calendarios (desde el grupo):*\n"
    "  `/subscribe_calendar <url> [nombre]` — vincular calendario Google\n"
    "  `/unsubscribe_calendar <nombre_o_id>` — desvincular calendario\n"
    "  `/list_calendars` — ver calendarios vinculados\n\n"
    "*ℹ️ Sistema:*\n"
